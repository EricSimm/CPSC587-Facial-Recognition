""" MainPage for SMILE facial recognition application created for CPSC587 by:
Zenan Li, Tiffany Lin, Viraj Deshwal, and Eric Simmons
The application recognizes faces that have been added to the applicaiton. New Faces can be added
GUI generated by PyQT5.6 Generator
File created by: Eric Simmons
...
class Ui_mainPage(object):
    ...
    #go to aboutPage, which is now labeled as Instructions.
